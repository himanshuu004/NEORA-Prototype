        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 hover:bg-blue-700 rounded-full flex items-center justify-center transition-colors"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                ...
                <span>123 Clinic Street, City, State 12345</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:contact@neora.com" className="hover:text-white transition-colors">
                  contact@neora.com
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="mt-6">
              <a 
                href="tel:+1234567890"
                className="inline-block bg-white text-blue-600 px-6 py-3 rounded-full font-semibold hover:bg-blue-50 transform hover:scale-105 transition-all duration-300"
              >
                Book Appointment
              </a>
            </div>
